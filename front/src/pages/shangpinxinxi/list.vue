...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","boxShadow":"0 4px 10px rgba(0,0,0,.3)","margin":"10px auto","alignItems":"center","borderRadius":"30px","flexWrap":"wrap","background":"#fff","display":"flex","width":"83%","height":"auto"}'>
      <el-form-item :style='{"border":"1px solid #000","margin":"0","flex":"1","borderWidth":"0 0px 0 0"}'>
	    <div class="lable" v-if="false" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>商品名称：</div>
      ...
      <el-form-item :style='{"border":"1px solid #000","margin":"0","flex":"1","borderWidth":"0 0px 0 0"}'>
	    <div class="lable" v-if="false" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>商品品牌：</div>
	...
	<div class="sort_view" :style='{"margin":"10px auto 0","borderRadius":"30px 30px 0 0","background":"#3554A4","display":"flex","width":"83.5%","position":"relative","justifyContent":"center","zIndex":"111"}'>
		<el-button :style='{"border":"0","padding":"0 15px","margin":"0 5px","borderRadius":"8px","background":"none"}' @click="sortClick('price')">
			<span :style='{"margin":"0 5px 0 0","lineHeight":"50px","fontSize":"15px","color":"#fff"}' class="icon iconfont icon-chujia13" v-if="sortType!='price'"></span>
			<span :style='{"margin":"0 5px 0 0","lineHeight":"50px","fontSize":"15px","color":"#fff"}' class="icon iconfont icon-jiantou06" v-else-if="sortType=='price'&&sortOrder=='desc'"></span>
			<span :style='{"margin":"0 5px 0 0","lineHeight":"50px","fontSize":"15px","color":"#fff"}' class="icon iconfont icon-jiantou07" v-else-if="sortType=='price'&&sortOrder=='asc'"></span>
			<span :style='{"color":"#fff","lineHeight":"50px","fontSize":"15px"}'>价格</span>
		</el-button>
	...
	<div class="list" :style='{"width":"100%","padding":"30px 10% 230px","margin":"0px 0 10px","background":"url(http://codegen.caihongy.cn/20240219/48efb4be31ee443597196e704f0766c2.png) center bottom / 100% auto no-repeat,url(http://codegen.caihongy.cn/20240219/e541597a8bf34224a765175ed4cb8569.png) repeat-y center top / 100% auto"}'>
		...
		<!-- 样式二 -->
		<div class="list2 index-pv1" :style='{"padding":"0px","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
			<div :style='{"border":"2px solid #fff","cursor":"pointer","padding":"20px","boxShadow":"0 4px 10px rgba(0,0,0,.3)","margin":"0 0 30px","alignItems":"center","color":"#000","display":"flex","background":"#fff","width":"49%","fontSize":"0","position":"relative","height":"auto"}' v-for="(item, index) in dataList" :key="index" @click.stop="toDetail(item)" class="list-item animation-box">
				<div :style='{"border":"0","width":"200px","padding":"0","overflow":"hidden","height":"240px"}'>
				...
				<div class="item-info" :style='{"width":"calc(100% - 200px)","padding":"10px","overflow":"hidden","flexWrap":"wrap","display":"flex","height":"240px"}'>
					<div :style='{"padding":"0 10px","color":"inherit","width":"100%","lineHeight":"50px","fontSize":"18px","fontWeight":"bold","order":"1"}' class="name ">{{item.shangpinmingcheng}}</div>
					<div :style='{"padding":"0 10px","color":"inherit","width":"100%","lineHeight":"50px","fontSize":"18px","fontWeight":"bold","order":"1"}' class="name ">{{item.shangpinfenlei}}</div>
					...
					<div :style='{"padding":"0 10px","order":"5"}'>
					  ...
					  <span :style='{"color":"inherit","lineHeight":"30px","fontSize":"14px"}'>{{item.shangjiazhanghao}}</span>
					</div>
					...
					<div :style='{"padding":"0 10px","order":"4"}'>
					  <span class="icon iconfont icon-chakan9" :style='{"margin":"0 5px 0 0","lineHeight":"30px","fontSize":"14px","color":"inherit"}'></span>
					  <span :style='{"color":"inherit","lineHeight":"30px","fontSize":"14px"}'>{{item.clicknum}}</span>
					</div>
				</div>
			</div>
		</div>
