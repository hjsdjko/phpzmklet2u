		...
		<div class="attr" :style='{"minHeight":"75px","padding":"0","background":"none","flex":"1","display":"flex","width":"55%","position":"relative","order":"2"}'>
			...
			<div class="info" :style='{"padding":"10px","margin":"0 0 0 0","background":"#fff","flex":"1"}'>
				...
				<div class="item" :style='{"padding":"0px","margin":"0 0 10px 0","background":"#fff","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","whiteSpace":"nowrap","color":"#9e9e9e","textAlign":"right","width":"102px","fontSize":"14px","lineHeight":"24px"}'>分类名称</div>
				...
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","textAlign":"left","display":"block"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 auto 10px","outline":"none","color":"#fff","borderRadius":"10px","background":"#3554A4","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('newstype','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 auto 10px","outline":"none","color":"#000","borderRadius":"10px","background":"#FFC174","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('newstype','删除')" @click="delClick">删除</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 auto 10px","outline":"none","color":"#000","borderRadius":"10px","background":"#FFC174","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('newstype','私聊')&&detail.id!=mid" @click="chatClick">联系TA</el-button>
				</div>
			</div>
		</div>
  ...
  export default {
    ...
    methods: {
      ...
      sizeChange(size){
		...
		// 删除
		async delClick(){
			await this.$confirm('是否删除此通知公告分类？')
			  .then(_ => {
